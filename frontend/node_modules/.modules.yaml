{
  "hoistedDependencies": {
    ...
    "vitefu@1.1.3(vite@8.0.12(@types/node@24.12.3)(jiti@2.7.0))": {
      "vitefu": "private"
    },
    ...
    "@vitest/browser@4.1.5(vite@8.0.12(@types/node@24.12.3)(jiti@2.7.0))(vitest@4.1.5)": {
      "@vitest/browser": "private"
    },
    "@vitest/mocker@4.1.5(vite@8.0.12(@types/node@24.12.3)(jiti@2.7.0))": {
    ...
    "@testing-library/svelte-core@1.0.0(svelte@5.55.5(@typescript-eslint/types@8.59.2))": {
      "@testing-library/svelte-core": "private"
    },
    "@vitest/expect@4.1.5": {
  ...
  "pendingBuilds": [],
  "publicHoistPattern": [],
  "prunedAt": "Mon, 22 Jun 2026 07:43:15 GMT",
  "registries": {
  ...
  "storeDir": "/workspaces/ir-anthology/frontend/.pnpm-store/v11",
